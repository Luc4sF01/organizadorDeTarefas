...
export default function Tabs({ categoriaAtiva, onMudarCategoria }: TabsProps) {
  const categorias = Object.keys(CATEGORIAS) as Categoria[]

  return (
    <nav className="flex mb-6 border-b border-[#1c1c1c]">
          ...
          <button
            ...
            className={`
              ...
              ${ativa
                ...
                : 'border-transparent text-[#52525b] hover:text-[#71717a] hover:border-[#2a2a2a]'
              }
            `}
          >
